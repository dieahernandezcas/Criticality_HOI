...
def loadDefaultParams(Cmat=None, Dmat=None, seed=None):
    ...
    # NEW: Parameters for the modified activation function from the paper
    params.beta_val = 0.1  # Value for beta in the tanh activation function (ms^-1)
    params.gamma_val = 3.0 # Value for gamma in the tanh activation function (for superlinearity and bistability)
